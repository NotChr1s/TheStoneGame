...
/**
 * Write a description of class SelectedAttackButton here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class SelectedAttackButton extends Button
{
    private long idBuyObject;
    private MySkinsWorld currentMySkinsWorld;
    
    public SelectedAttackButton(String imageButton, String imageSelectButton, String imagePresionedButton, long id, MySkinsWorld currentMySkinsWorld){
